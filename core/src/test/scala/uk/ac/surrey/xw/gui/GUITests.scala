...
import uk.ac.surrey.xw.gui.Strings.CreateTab
import uk.ac.surrey.xw.state.Strings.propertyMustBeNonEmpty
import uk.ac.surrey.xw.state.Strings.propertyMustBeUnique
